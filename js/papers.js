...
const papersData = [
	...
	id: 24,
    	...
    	code: null,
    	keywords: ["Hyperspectral image classification (HSI)", "vision transformer (ViT)", "convolutional neural networks (CNN)", "sequencedata; feature fusion"],
	// Model image fields
    	hasModelImage: true,
	...
	id: 25,
    	...
    	code: null,
    	keywords: ["Hyperspectral image classification", "convolutional neural network", "Vision Transformer", "dual-branch feature interaction"],
	// Model image fields
    	hasModelImage: true,
	...
	id: 33,
    	...
    	code: null,
    	keywords: [ "Convolutional neural network (CNN)", "hierarchical feature fusion (HFF)", "hierarchical shrinkage multiscale network (HSMSN)", "hyperspectral image classification(HSIC)", "multidepth and multiscale residual block (MDMSRB)"],
	// Model image fields
    	hasModelImage: true,
